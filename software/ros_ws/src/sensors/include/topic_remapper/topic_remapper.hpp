 ...
 * at a lower frequency. It uses ROS 2's generic subscription and publisher
 * capabilities to handle any message type without compile-time knowledge of the
 * specific types.
 */
...
private:
     ...
     *
     * This method is called to set up the subscription after the topic name is
     * known. It automatically detects the message type and creates an appropriate
     * subscription.
     */
    ...
    static constexpr int MAX_DETECTION_ATTEMPTS =
        50;  // ~5 seconds at 100ms intervals
