 ...
 */
inline ImuData apply_calibration(const ImuData &raw_data, double accel_scale_x,
                                 double accel_scale_y, double accel_scale_z,
                                 double accel_offset_x, double accel_offset_y,
                                 double accel_offset_z, double gyro_scale_x,
                                 double gyro_scale_y, double gyro_scale_z,
                                 double gyro_offset_x, double gyro_offset_y,
                                 double gyro_offset_z) {
  ImuData calibrated_data = raw_data;

  // Apply calibration to accelerometer data: calibrated = (raw - offset) *
  // scale
