...
private:
    ...
    const std::vector<std::pair<
        std::string, hi_can::addressing::legacy::power::control::rcb::groups>>
        BUS_GROUPS = {
            {"compute", hi_can::addressing::legacy::power::control::rcb::groups::
                            COMPUTE_BUS},
            {"drive",
    ...
    std::vector<
        std::pair<std::string, hi_can::parameters::legacy::power::control::
                                   power_bus::PowerBusParameterGroup>>
        _parameter_groups;
