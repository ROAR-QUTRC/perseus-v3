...
inline const std::vector<std::string> CLASS_NAMES = {"blue", "green", "red",
                                                     "white"};
...
private:
  ...
  void
  depth_camera_info_callback(const sensor_msgs::msg::CameraInfo::SharedPtr msg);
  ...
  void publish_depth_markers(const std::vector<Detection> &detections,
                             const std_msgs::msg::Header &header);
  void publish_2d_detections(const std::vector<Detection> &detections,
                             const std_msgs::msg::Header &header);
  bool estimate_cube_pose_from_depth(const Detection &detection,
                                     geometry_msgs::msg::Pose &pose_out,
                                     double &distance_m_out) const;
  bool read_depth_meters_at_pixel(const sensor_msgs::msg::Image &depth_msg,
                                  int u, int v, double &depth_m_out) const;
  geometry_msgs::msg::Quaternion quaternion_from_yaw_pitch(double yaw,
                                                           double pitch) const;
  bool
  transform_pose_to_output_frame(const geometry_msgs::msg::Pose &input_pose,
                                 const std::string &target_frame,
                                 const std::string &source_frame,
                                 const builtin_interfaces::msg::Time &stamp,
                                 geometry_msgs::msg::Pose &output_pose) const;
  void run_inference_pipeline(const cv::Mat &bgr_image,
                              const std_msgs::msg::Header &header);
  ...
  rclcpp::Subscription<sensor_msgs::msg::CameraInfo>::SharedPtr
      _sub_depth_camera_info;

  // publishers
  rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr _pub_annotated;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr
      _pub_cube_markers;
  rclcpp::Publisher<perseus_interfaces::msg::ObjectDetections>::SharedPtr
  ...
  std::vector<sensor_msgs::msg::RegionOfInterest>
      _latest_detection_regions_of_interest;
