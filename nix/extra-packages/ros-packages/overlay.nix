...
let
  ...
  thirdPartyPackages = (import ./third-party/overlay.nix rosDistro);
  # ros2nix autogenerated package overlay location from perseus-v3/nix folder
  localPackagingOverlay = import ./perseus/overlay.nix;
    ...
    (prev.lib.composeManyExtensions [
      ...
      (
        ...
        let
          ...
          */
          devPackages = removeAttrs allDevPackages [ "simulation" ];
