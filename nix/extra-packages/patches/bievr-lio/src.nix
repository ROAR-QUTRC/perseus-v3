...
# configurable subscription QoS and bounded synchronizer queues.
#
...
fetchFromGitHub {
  owner = "bocho0600";
  repo = "BIEVR-LIO";
  rev = "fa213f75f0fb9597c2cac558b8e2c345d2d04343"; # feat/configurable-frames
  hash = "sha256-7/WZvhinbdKa3nKLnzmyatuQqgcAkX+6q2uHekOI7y4=";
}
